//This is where the magic happens - the app searches Pinecone for relevant syllabus snippets and send them to Groq (Llama 3) to answer student questions.
...
export async function querySyllabus(question: string, userId: string) {
  ...
  //search Pinecone for the top 3 most relevant chunks
  ...
  //send context + question to Groq (Llama 3)
